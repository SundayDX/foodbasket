    ...
    <template #statistics>
      <el-col :span="6">
        <statistic-card
          ...
          unit="%"
          :trend="statistics.passRateRatio"
        />
      </el-col>
      <el-col :span="6">
        <statistic-card
      ...
      <el-col :span="6">
        <statistic-card
          ...
          unit="%"
          :trend="statistics.completionRatio"
        />
      </el-col>
    </template>
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <chart-card
            ...
            @range-change="handlePassRateTimeChange"
          />
        </el-col>
        <el-col :span="12">
          <chart-card
            title="问题类型分布"
            :options="issueTypesChartOptions"
            :loading="loading.issueTypes"
            @range-change="handleIssueTypesTimeChange"
          />
        </el-col>
      </el-row>
      <el-row :gutter="20" class="mt-4">
        <el-col :span="24">
          <chart-card
            ...
            @range-change="handleSupplierTimeChange"
          />
        </el-col>
      </el-row>
    </template>
...
// 图表选项
const passRateChartOptions = ref<EChartsOption>({
  tooltip: {
    trigger: 'axis'
  },
  legend: {
...
const issueTypesChartOptions = ref<EChartsOption>({
  tooltip: {
    trigger: 'item'
  },
  legend: {
...
const supplierChartOptions = ref<EChartsOption>({
  tooltip: {
    trigger: 'axis',
    axisPointer: {
      type: 'shadow'
